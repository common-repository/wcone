...
trait ZipcodeMultiInput {
	...
	protected static function zipcode_multiinput_markup() {
		...
		?>
		<div class="wcone-admin-field fb-zip-conditional-field" data-condition="<?php echo esc_html($conditionData); ?>">
			...
			<div class="pickup-time-repeater">
		        ...
		        <span class="addRepeaterFieldMultiInput fb-admin-btn"><?php esc_html_e( 'Add Zip Code', 'wcone' ); ?></span>
			</div>
        </div>
		<?php
	}
