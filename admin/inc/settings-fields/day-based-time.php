			...
			<div class="day-based-time">
                <div class="field-wrapper-fd">
	                ...
	                <div class="holy-day-checkbox">
	                	<p><?php esc_html_e( 'HoliDay?', 'wcone' ); ?></p>
	              	...
	              	<div class="day-field-group">
	              		<p><?php esc_html_e( 'Opening Time', 'wcone' ); ?></p>
	                ...
	                <div class="day-field-group">
	                	<p><?php esc_html_e( 'Closing Time', 'wcone' ); ?></p>
	                ...
	                <div class="day-field-group">
	                	<p><?php esc_html_e( 'Break Start Time', 'wcone' ); ?></p>
	                ...
	                <div class="day-field-group">
	                	<p><?php esc_html_e( 'Break End Time', 'wcone' ); ?></p>
