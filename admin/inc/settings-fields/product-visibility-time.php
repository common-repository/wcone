...
trait Product_Visibility_Time {
	...
	protected static function product_visibility_time_markup() {
		...
		?>
		<div class="wcone-admin-field text-repeater fb-address-conditional-field" data-condition="<?php echo esc_html( $conditionData ); ?>">
			...
			<div class="pickup-time-repeater product-visibility-time">
		        ...
		        ?>
		          ...
		          <span class="removeRepeaterField fb-admin-btn"><?php esc_html_e( 'Remove', 'wcone' ); ?></span>
		        ...
		        <span class="addProductVisibilityTime fb-admin-btn"><?php esc_html_e( 'Add Visibility Type', 'wcone' ); ?></span>
