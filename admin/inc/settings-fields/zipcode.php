...
trait Zipcode {
	...
	public function zipcode( $args ) {
		...
		$default = [
			...
			'name'	=> '',
			'description'	=> '',
			'add_btn_text'	=> esc_html__( 'Add', 'wcone' ),
			'wrap_class'	=> '',
			'condition'		=> '',
			'is_pro'		=> false
		];
	...
	protected static function zipcode_markup() {
		...
		?>
		<div class="wcone-admin-field <?php echo esc_attr( $args['wrap_class'] ); ?>" data-condition="<?php echo esc_attr($conditionData); ?>">
			...
			<div class="pickup-time-repeater">
                ...
                ?>
                  ...
                  <span class="removetime fb-admin-btn"><?php esc_html_e( 'Remove', 'wcone' ); ?></span>
                  </div>
                <?php 
                endforeach;
                endif
