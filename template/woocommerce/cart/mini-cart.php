				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<div class="rb_quantity rb_d_flex rb_align_items_center">
		            	<div class="rb_input_group">
		                  ...
		                  <span class="inc-qty rb_minus rb_minus_2"><img src="<?php echo WCONE_DIR_ASSETS_URL.'img/icon/minus1.svg'; ?>"></span>
		                  <span class="inc-qty rb_plus rb_plus_2"><img src="<?php echo WCONE_DIR_ASSETS_URL.'img/icon/plus1.svg'; ?>"></span>
		            	</div>
		            </div>
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'wcone' ),
							esc_attr( $product_id ),
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'wcone' ); ?></p>
